...
from os.path import dirname, basename, normpath, join, exists, join
...
class UrlGetter(HTMLParser):
    """
    Analyzes HTML web page to find URLs.
    """
    ...
    def add_interactive_tag(
        ...
        """
        Adds the tag dynamic score to dynamic counter.
        """
    ...
    def get_add_url(self, tag: str, attribute: str, value: str) -> None:
        """
        Adds the value if it's URL attribute.
        """
...
class _Crawler(ABC):
    ...
    def add(self, parsed_url: ParseResult, url: str, request: bool) -> None:
        """
        Adds an URL if not already added.
        """
    ...
    def decode(self, data: bytes) -> str:
        """
        Try to decode data using utf-8 and latin-1.
        """
    ...
    def reader(self, response: HTTPResponse) -> bytes:
        """
        Exception for the IncompleteRead error.
        """
    ...
    def parse_sitemap(self, url: Union[str, ParseResult]) -> bool:
        """
        Requests a sitemap URL and/or parse it.
        """
    ...
    def ask_crossdomain(self, url: ParseResult) -> None:
        """
        Send request for crossdomain.xml
        """
    ...
    def get_url_and_data(
        ...
        """
        Gets url, parses it and gets data from it.
        """
    ...
    def read_and_parse(
        ...
        """
        Reads the response and parses it.
        """
    ...
    def get_local_filepath(self, url: ParseResult) -> str:
        """
        Local file path to store the response content.
        """
    ...
    def write_response(
        ...
        """
        Writes the response content for a URL.
        """
    ...
    def write_error(
        ...
        """
        Writes the response content on HTTP error.
        """
    ...
    def prepare_request(
        ...
        """
        Prepares the request and response parsing.
        """
    ...
    if selenium:
        ...
        def add_cookies(self) -> None:
            """
            Adds cookie to selenium web driver.
            """
        ...
        def get_data(
            ...
            """
            Gets the Web page content after javascript execution
            using selenium.
            """
...
if format_output:
    ...
    class CrawlerColoredPrinter(_CrawlerPrinter):
        ...
        def get_pourcent(self):
            """
            Returns the pourcents of URL requested.
            """
...
def parse_args() -> Namespace:
    ...
    parser = ArgumentParser(
        description="Crawls web site and prints URLs."
    )
    ...
    add(
        ...
        "--report",
        "-F",
        default=join(getcwd(), "reports", "CrawlerReport_"
...
def main() -> int:
    """
    Starts the script from the command line.
    """
    ...
    reports_dir = dirname(arguments.report_filename)
